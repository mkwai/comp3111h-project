...
public class CalendarView extends ImageView {
    ...
    public void nextMonth() {
    	...
    	initCells();
    	invalidate();
    	/// day does NOT change when next/previous month press
		DailyView.setDailyYear(getYear());
		DailyView.setDailyMonth(getMonth());

		AddEvent.currentDateCalendar.set(Calendar.YEAR, getYear());
		AddEvent.currentDateCalendar.set(Calendar.MONTH, getMonth());
