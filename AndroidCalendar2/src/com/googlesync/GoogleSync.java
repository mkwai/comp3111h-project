...
public class GoogleSync {
	...
	public void getEventEntry(CalendarEventEntry entry) {
		...
		if (temp.length()==0 ){  
			...
			// old google event -> update record
...
*/
	...
	private int past=30;
	private int future=30;
	private String year= DateFormat.format("yyyy", currentDateCalendar).toString();
	private String month= DateFormat.format("MM", currentDateCalendar).toString();
	private String date= DateFormat.format("dd", currentDateCalendar).toString();
	
	public void setPast(int past){ this.past= past;	}
	public void setFuture(int future){ this.future= future;}
