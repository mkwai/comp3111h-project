...
public class TodoList extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.i("create","todolist");
		setContentView(R.layout.todolist);

		Log.i("created","todolist view");
		...
		Log.i("created","todolist view2.5");


		Log.i("created","todolist view3");
		...
		//delte all finished task
		final AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setMessage("Are you sure to delete all finished tasks ?");
			...
			public void onClick(DialogInterface dialog, int id) {
				...
				try {
					...
					for (int i = 0; i < temp.length(); i++) {
						...
						if(Integer.parseInt(tempProgress) ==100)
							 AndroidCalendar2Activity.getDB().delete("TaskTable",tempId);
					}
					list.clear();
					addTaskToList(TodoList.this);
					listview.invalidateViews();
	...
	private void addTaskToList(final Context t) {
		...
		Log.i("addTaskTolist","enter function");
		...
		if (temp.length() > 0) {
			...
			try {
				...
				Log.i("addTaskTolist","enter function2");
				...
				Log.i("addtasktolistException", e.toString());
			}
